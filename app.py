...
GEMINI_MODEL = get_config_value("ai", "gemini_model", "gemini-2.5-flash")
OPENAI_KEY = get_config_value("ai", "openai_key", "")
OPENAI_MODEL = get_config_value("ai", "openai_model", "gpt-4o")

# Reliable cross-platform output directory
OUTPUT_DIR = os.path.join(tempfile.gettempdir(), "NewsAppOutputs")
